...
parser.add_argument('--input_path', type=str,
                    default='/home/pxk/CBREN/datasets/test/hevc_cbr_high/D/BasketballPass_416x240_50/',
                    help='input path to use')
parser.add_argument('--output_path', default='results/hevc_cbr_high/',
                    type=str,
                    help='where to save the output image')
parser.add_argument('--gt_path', type=str,
                    default='/home/pxk/CBREN/datasets/test/hevc_gt_frame/D/BasketballPass_50/',
                    help='gt path to use')
parser.add_argument('--model', type=str, default='checkpoints/original/epoch_57_best_psnr_29.0870.pth',
