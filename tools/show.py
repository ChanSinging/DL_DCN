...
def show_img(Enhanced_Y, non_PQF_Frame_96_Y, non_PQF_Frame_96_U, non_PQF_Frame_96_V, Height, Width):
    ...
    Enhanced_ball_R = np.array(Image.fromarray(Enhanced_R[117: 147, 75: 105] / 255.0).resize([150, 150], 'bilinear', mode='F'))
    Enhanced_ball_G = np.array(Image.fromarray(Enhanced_G[117: 147, 75: 105] / 255.0).resize([150, 150], 'bilinear', mode='F'))
    Enhanced_ball_B = np.array(Image.fromarray(Enhanced_B[117: 147, 75: 105] / 255.0).resize([150, 150], 'bilinear', mode='F'))

    HEVC_ball_R = np.array(Image.fromarray(HEVC_R[117: 147, 75: 105] / 255.0).resize([150, 150], 'bilinear', mode='F'))
    HEVC_ball_G = np.array(Image.fromarray(HEVC_G[117: 147, 75: 105] / 255.0).resize([150, 150], 'bilinear', mode='F'))
    HEVC_ball_B = np.array(Image.fromarray(HEVC_B[117: 147, 75: 105] / 255.0)/resize([150, 150], 'bilinear', mode='F'))
