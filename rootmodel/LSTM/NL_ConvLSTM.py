...
if __name__ == '__main__':
    ...
    img1 = Image.open("../../datasets/gt_mp4/D/001.png").convert("RGB")
    img2 = Image.open("../../datasets/gt_mp4/D/004.png").convert("RGB")
    ...
    model1 = NonLocalBlock(3, p=10, k=4, temperature=1e-3)
    model2 = NonLocal(3, 3)
    output = model2(img2, img1, img1)
    print(output.size())
    print(img1.size())
