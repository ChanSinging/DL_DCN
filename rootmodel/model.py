...
#         self.downscale_1 = nn.Sequential(
#             PixelUnshuffle(downscale_factor=2),
#             nn.Conv2d(in_channels=3 * 2 * 2, out_channels=n_channels,
#                       kernel_size=5, stride=1, padding=2, bias=False)
#         )
#         self.conv_relu_1 = ConvRelu(in_channels=n_channels, out_channels=n_channels, kernel=3, padding=1)
#         self.dual_domain_blocks_1 = self.make_layer(
#             block=DualDomainBlock,
#             num_of_layer=self.n_pyramids)
...
#         self.dual_domain_blocks_2 = self.make_layer(
#             block=DualDomainBlock,
#             num_of_layer=self.n_pyramids)
#         self.conv_relu_4 = ConvRelu(in_channels=n_channels, out_channels=n_channels, kernel=3, padding=1)
#         self.upscale_2 = nn.Sequential(
#             nn.Conv2d(in_channels=n_channels, out_channels=n_channels * 4,
#                       kernel_size=3, stride=1, padding=1, bias=False),
#             nn.PixelShuffle(2)
#         )
#
#         self.conv_relu_5 = ConvRelu(in_channels=n_channels * 2, out_channels=n_channels, kernel=3, padding=1)
#         self.upscale_1 = nn.Sequential(
#             nn.Conv2d(in_channels=n_channels, out_channels=n_channels * 4,
#                       kernel_size=3, stride=1, padding=1, bias=False),
#             nn.PixelShuffle(2)
#         )
#         self.conv_relu_6 = ConvRelu(in_channels=n_channels, out_channels=3, kernel=5, padding=2)
#
#     def make_layer(self, block, num_of_layer):
#         layers = []
#         for _ in range(num_of_layer):
...
#
#     def forward(self, x):
#         t = self.downscale_1(x)
#         t = self.conv_relu_1(t)
#         t = self.dual_domain_blocks_1(t)
#         t = self.conv_relu_2(t)
#
#         # t_2 = self.downscale_2(t)
#         # t_2 = self.conv_relu_3(t_2)
#         # t_2 = self.dual_domain_blocks_2(t_2)
#         # t_2 = self.conv_relu_4(t_2)
#         # t_2 = self.upscale_2(t_2)
#         #
#         # t = torch.cat((t, t_2), 1)
#         # t = self.conv_relu_5(t)
#         t = self.upscale_1(t)
#         y = self.conv_relu_6(t)
#         return y


# class VECNN_X1X2X4(nn.Module):
#     def __init__(self, n_channels, n_pyramids, n_pyramid_cells, n_pyramid_channels):
#         super(VECNN_X1X2X4, self).__init__()
#         self.n_channels = n_channels
#         self.n_pyramids = n_pyramids
#         self.n_pyramid_cells = n_pyramid_cells
#         self.n_pyramid_channels = n_pyramid_channels
...
# class VECNN_X1X2X4X8(nn.Module):
#     def __init__(self, n_channels, n_pyramids, n_pyramid_cells, n_pyramid_channels):
#         super(VECNN_X1X2X4X8, self).__init__()
#         self.n_channels = n_channels
#         self.n_pyramids = n_pyramids
#         self.n_pyramid_cells = n_pyramid_cells
#         self.n_pyramid_channels = n_pyramid_channels
...
#                       kernel_size=5, stride=1, padding=2, bias=False)
#         )
#         self.downscale_3 = nn.Sequential(
#             PixelUnshuffle(downscale_factor=2),
#             nn.Conv2d(in_channels=n_channels * 2 * 2, out_channels=n_channels,
#                       kernel_size=5, stride=1, padding=2, bias=False)
#         )
...
#         self.conv_relu_X4_2 = ConvRelu(in_channels=n_channels, out_channels=n_channels, kernel=3, padding=1)
#
#         self.conv_relu_X8_1 = ConvRelu(in_channels=n_channels, out_channels=n_channels, kernel=3, padding=1)
#         self.dual_domain_blocks_x8 = self.make_layer(
#             block=DualDomainBlock,
#             num_of_layer=self.n_pyramids)
#         self.conv_relu_X8_2 = ConvRelu(in_channels=n_channels, out_channels=n_channels, kernel=3, padding=1)
#
#         self.conv_relu_channel_merge_1 = ConvRelu(in_channels=n_channels * 2, out_channels=n_channels, kernel=3,
#                                                   padding=1)
#         self.conv_relu_channel_merge_2 = ConvRelu(in_channels=n_channels * 2, out_channels=n_channels, kernel=3,
#                                                   padding=1)
#         self.conv_relu_channel_merge_3 = ConvRelu(in_channels=n_channels * 2, out_channels=n_channels, kernel=3,
#                                                   padding=1)
#         self.conv_relu_output = ConvRelu(in_channels=n_channels, out_channels=3, kernel=5, padding=2)
#
#     def make_layer(self, block, num_of_layer):
...
#     def forward(self, x):
#         t_x1 = self.channel_split(x)
#         t_x2 = self.downscale_1(x)
#         t_x4 = self.downscale_2(t_x2)
#         t_x8 = self.downscale_3(t_x4)
#
#         t_x1 = self.conv_relu_X1_1(t_x1)
#         t_x1 = self.dual_domain_blocks_x1(t_x1)
#         t_x1 = self.conv_relu_X1_2(t_x1)
...
#         t_x4 = self.conv_relu_X4_2(t_x4)
#
#         t_x8 = self.conv_relu_X8_1(t_x8)
#         t_x8 = self.dual_domain_blocks_x8(t_x8)
#         t_x8 = self.conv_relu_X8_2(t_x8)
#
#         t_x8 = self.upscale_3(t_x8)
#         t_x4 = torch.cat((t_x8, t_x4), 1)
#         t_x4 = self.conv_relu_channel_merge_1(t_x4)
#         t_x4 = self.upscale_2(t_x4)
#         t_x2 = torch.cat((t_x2, t_x4), 1)
#         t_x2 = self.conv_relu_channel_merge_2(t_x2)
#         t_x2 = self.upscale_1(t_x2)
#         t = torch.cat((t_x1, t_x2), 1)
#         t = self.conv_relu_channel_merge_3(t)
#         y = self.conv_relu_output(t)
#         return y
